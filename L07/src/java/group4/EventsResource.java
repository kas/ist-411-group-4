...
public class EventsResource {
    ...
    @Produces(MediaType.TEXT_PLAIN)
    public String putEvent(final PutBody putBody) throws FileNotFoundException, IOException {
        ...
        final String oldEvent = putBody.oldEvent;
        final String newEvent = putBody.newEvent;
